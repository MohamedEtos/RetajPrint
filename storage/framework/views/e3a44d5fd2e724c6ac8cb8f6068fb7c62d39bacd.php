    ...
    <div class="row">
        <div class="col-12">
            <form method="POST" action="<?php echo e(route('update',$get->id)); ?>">
                ...
                <div class="alert alert-success mt-2"><?php echo e(Session::get('success')); ?></div>
                <?php endif; ?>
                <?php if(Session::has('faild')): ?>
                <div class="alert alert-danger mt-2"><?php echo e(Session::get('faild')); ?></div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mohamed Mahrous\Desktop\RetajPrint\resources\views/edit.blade.php ENDPATH**/ ?>