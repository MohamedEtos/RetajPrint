            ...
            <table class="table table-striped text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('deletelaravel',$data->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppServ\www\Laravel\RetajPrint\resources\views/allDataView.blade.php ENDPATH**/ ?>